...
const POP_2020: Record<number, number> = {
  1: 5250, 2: 1238, 3: 1210, 4: 2304, 5: 959, 6: 1068, 7: 1832, 8: 2860,
  9: 1933, 10: 1939, 11: 7345, 12: 6284, 13: 14047, 14: 9237, 15: 2204,
  16: 1040, 17: 1132, 18: 766, 19: 811, 20: 2048, 21: 1977, 22: 3632,
  23: 7542, 24: 1770, 25: 1414, 26: 2579, 27: 8838, 28: 5460, 29: 1324,
  30: 922, 31: 553, 32: 671, 33: 1882, 34: 2810, 35: 1342, 36: 719,
  37: 958, 38: 1335, 39: 691, 40: 5136, 41: 811, 42: 1313, 43: 1738,
  44: 1124, 45: 1070, 46: 1608, 47: 1467,
};

const YEARS = [1980, 1985, 1990, 1995, 2000, 2005, 2010, 2015, 2020];

// 総人口の1980→2020の変化率（都道府県ごとのトレンド近似）
function getTotalPopulationSeries(prefCode: number): { year: number; value: number }[] {
  const base = (POP_2020[prefCode] ?? 1000) * 1000;
  return YEARS.map((year, i) => {
    const t = (year - 1980) / 40;
    const ratio = 0.85 + 0.15 * t + (prefCode === 13 ? 0.25 * t : 0);
    return { year, value: Math.round(base * ratio * (0.92 + 0.08 * (year - 1980) / 40)) };
  });
}
